# Generated by Powerlevel10k configuration wizard on 2020-06-21 at 15:23 EET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 15764.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# angled separators, round heads, flat tails, 2 lines, disconnected, left frame,
...
() {
  ...
  prompt_my_wifi_signal(){
        ...
        if [ "$airport" = "Off" ]; then
                ...
                p10k segment -i '' -b green -f black -t ${ssid}
        fi
}
  ...
  #
    ...
    # typeset -g POWERLEVEL9K_WIFI_VISUAL_IDENTIFIER_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}${my_wifi_icon[P9K_WIFI_SSID]}'
  #
